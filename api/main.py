...
from engine import alpaca_trading, live_scanner, market_overview, signals_db
from engine import quotes as quotes_module
from engine.logging_db import latest_run_per_strategy, run_history
...
def list_strategies() -> list[dict]:
    ...
    for name in ALL_STRATEGY_NAMES:
        ...
        # /api/backtest. Surfacing which engine here lets the UI pick the
        # right endpoint/result view instead of guessing from the name.
