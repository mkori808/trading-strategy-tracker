"""Track 3: Composite V3.1 (IC-weighted, 5-signal spec, IBS earnings-
conditioned per this track's config). All track-specific behavior lives
in config.json under tracks.composite_v3_1 -- this module just names it
so it can be run/imported individually."""
